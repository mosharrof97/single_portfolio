...
@section('content')
    ...
    <div class="card" id="contantCard">
        ...
        @if (!empty($addressDetails))
            <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <div class="text-end">
                            <button class="btn btn-primary" id="details_edit"
                                aria-label="Click on Edit to fill up address details"><i
                ...
                <div class="" id="addressDetailsEdit" style="display:none">
                    <form action="{{ route('address.details.update') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 pr-control btn-form-control">
                                        <div class="form-group">
                                            <select class="form-control district" aria-label="Present district"
                                                id="present_district" name="present_district">
                                                <option value="" selected="">Select District</option>
                                                @foreach ($districts as $value)
                                                    <option value="{{ $value->district }}"
                                                        {{ $value->district == $addressDetails->present_district ? 'selected' : '' }}>
                                    ...
                                    <div class="col-sm-4 p-control btn-form-control">
                                        <div class="form-group" id="present_thanaLocation">
                                            <select aria-label="present thana" class="form-control" id="present_thana"
                                                name="present_thana"
                                                onchange="GetLoadLocations(1,'present','EN','addressForm');"
                                                aria-describedby="presenttxtThanaErrorMsg">
                                                <option value="{{ $addressDetails->present_thana }}">
                                                    {{ $addressDetails->present_thana }}</option>
                                            </select>
                                    ...
                                    <div class="col-sm-4 pl-control btn-form-control">
                                        <div class="form-group" id="present_POLocation">
                                            <input type="text" name="present_office" id="present_office"
                                                aria-label="present post office" class="form-control"
                                                value="{{ $addressDetails->present_office }}"
                                                placeholder="Type your post office">
                                ...
                                <div class="form-group btn-form-control">
                                    <input type="text" class="form-control" id="present_village" name="present_village"
                                        aria-label="present Village" value="{{ $addressDetails->present_village }}"
                                        placeholder="Type your House No/Road/Village" maxlength="150">
                            ...
                            <div class="col-md-12">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="checkbox btn-form-control">
                                        <label><input type="checkbox" class="same-address" name="same_address"
                                                id="same_address">Same as Present Address</label>
                                    </div>
                                </div>
                                <div class="">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4 pr-control btn-form-control">
                                            <div class="form-group">
                                                <select aria-label="permanent district" class="form-control district"
                                                    id="permanent_district" name="permanent_district">
                                                    <option value="" selected="">Select District</option>
                                                    @foreach ($districts as $value)
                                                        <option value="{{ $value->district }}"
                                                            {{ $value->district == $addressDetails->permanent_district ? 'selected' : '' }}>
                                                            {{ $value->district }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-4 p-control btn-form-control">
                                            <div class="form-group" id="permanent_thanaLocation">
                                                <select aria-label="permanent thana" class="form-control thanacommon"
                                                    id="permanent_thana" name="permanent_thana">
                                                    <option value="{{ $addressDetails->permanent_thana }}">
                                                        {{ $addressDetails->permanent_thana }}</option>
                                                </select>
                                        ...
                                        <div class="col-sm-4 pl-control btn-form-control">
                                            <div class="form-group" id="permanent_POLocation">
                                                <input type="text" name="permanent_office" id="permanent_office"
                                                    aria-label="present post office" class="form-control"
                                                    value="{{ $addressDetails->permanent_office }}"
                                                    placeholder="Type your post office">
                                    ...
                                    <div class="form-group btn-form-control">
                                        <input aria-label="parmanent village" type="text" class="form-control"
                                            id="permanent_village" name="permanent_village"
                                            value="{{ $addressDetails->permanent_village }}"
                                            placeholder="Type your House No/Road/Village"
                                            aria-describedby="txtprmtVillErrorMsg" maxlength="150">
                            ...
                            <div class="col-md-12">
                                <div class="btn-form-control">
                                    <button type="submit" aria-label="CLick to save address information "
                                    ...
                                    <a href="https://mybdjobs.bdjobs.com/new_mybdjobs/step_01_view.asp"
                                        ...
                                        id="addressCloseBtn" class="btn btn-default btn-cancel reset">Close</a>
                                </div>
                            </div>
                        </div>
                    </form>
        ...
        @else
            <div class="card-body">
                <form action="{{ route('address.details') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-sm-4 p-control btn-form-control">
                                    <div class="form-group" id="present_thanaLocation">
                                        <select aria-label="present thana" class="form-control thanacommon"
                                            id="present_thana" name="present_thana"
                                            onchange="GetLoadLocations(1,'present','EN','addressForm');"
                                            aria-describedby="presenttxtThanaErrorMsg">
                                ...
                                <div class="col-sm-4 pl-control btn-form-control">
                                    <div class="form-group" id="present_POLocation">
                                        <input type="text" name="present_office" id="present_office"
                                            aria-label="present post office" class="form-control"
                                            value="{{ old('present_office') }}" placeholder="Type your post office">
                            ...
                            <div class="form-group btn-form-control">
                                <input type="text" class="form-control" id="present_village" name="present_village"
                                    aria-label="present Village" value=""
                                    placeholder="Type your House No/Road/Village" maxlength="150">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 pl-control btn-form-control">
                                    <div class="form-group" id="permanent_POLocation">
                                        <input type="text" name="permanent_office" id="permanent_office"
                                            aria-label="present post office" class="form-control"
                                            value="{{ old('permanent_office') }}" placeholder="Type your post office">
                            ...
                            <div class="form-group btn-form-control">
                                <input aria-label="parmanent village" type="text" class="form-control"
                                    id="permanent_village" name="permanent_village" value=""
                                    placeholder="Type your House No/Road/Village" maxlength="150">
        ...
        $(document).ready(function() {
            ...
            $('#same_address').change(function() {
                if ($(this).prop('checked')) {
                    ...
                    $('#permanent_district, #permanent_thana, #permanent_office, #permanent_village').val(
                        '').prop('readonly', false);
                }
            });
