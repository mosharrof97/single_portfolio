                            ...
                            <form action="{{ route('user.page_title_desc') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="bg_title" id="bg_title"
                                        value="{{ userSetting('about_title_desc') !== null ? userSetting('about_title_desc')->bg_title : '' }}">
                                </div>
                                <div class="form-group">
                                    <label for="title">Title</label>
                                    <input type="text" class="form-control" name="title" id="title"
                                        value="{{ userSetting('about_title_desc') !== null ? userSetting('about_title_desc')->title : '' }}">
                                </div>
                                <div class="form-group">
                        ...
                        <div class="card-body">
                            <form action="{{ route('user.page_title_desc') }}" method="post">
                                ...
                                <div class="form-group">
                                    <label for="bg_title">Big Title</label>
                                    <input type="text" class="form-control" name="bg_title" id="bg_title"
                                        value="{{ userSetting('service_title_desc') !== null ? userSetting('service_title_desc')->bg_title : '' }}">
                                </div>
                                <div class="form-group">
                                    <label for="title">Title</label>
                                    <input type="text" class="form-control" name="title" id="title"
                                        value="{{ userSetting('service_title_desc') !== null ? userSetting('service_title_desc')->title : '' }}">
                                </div>
                                <div class="form-group">
                                    <label for="desc">Description</label>
                        ...
                        <div class="card-body">
                            <form action="{{ route('user.page_title_desc') }}" method="post">
                                ...
                                <div class="form-group">
                                    <label for="bg_title">Big Title</label>
                                    <input type="text" class="form-control" name="bg_title" id="bg_title"
                                        value="{{ userSetting('resume_title_desc') !== null ? userSetting('resume_title_desc')->bg_title : '' }}">
                                </div>
                                <div class="form-group">
                                    <label for="title">Title</label>
                                    <input type="text" class="form-control" name="title" id="title"
                                        value="{{ userSetting('resume_title_desc') !== null ? userSetting('resume_title_desc')->title : '' }}">
                                </div>
                                <div class="form-group">
                                    <label for="desc">Description</label>
                        ...
                        <div class="card-body">
                            <form action="{{ route('user.page_title_desc') }}" method="post">
                                ...
                                <div class="form-group">
                                    <label for="bg_title">Big Title</label>
                                    <input type="text" class="form-control" name="bg_title" id="bg_title"
                                        value="{{ userSetting('skill_title_desc') !== null ? userSetting('skill_title_desc')->bg_title : '' }}">
                                </div>
                                <div class="form-group">
                                    <label for="title">Title</label>
                                    <input type="text" class="form-control" name="title" id="title"
                                        value="{{ userSetting('skill_title_desc') !== null ? userSetting('skill_title_desc')->title : '' }}">
                                </div>
                                <div class="form-group">
                                    <label for="desc">Description</label>
                        ...
                        <div class="card-body">
                            <form action="{{ route('user.page_title_desc') }}" method="post">
                                ...
                                <div class="form-group">
                                    <label for="bg_title">Big Title</label>
                                    <input type="text" class="form-control" name="bg_title" id="bg_title"
                                        value="{{ userSetting('blog_title_desc') !== null ? userSetting('blog_title_desc')->bg_title : '' }}">
                                </div>
                                <div class="form-group">
                                    <label for="title">Title</label>
                                    <input type="text" class="form-control" name="title" id="title"
                                        value="{{ userSetting('blog_title_desc') !== null ? userSetting('blog_title_desc')->title : '' }}">
                                </div>
                                <div class="form-group">
                                    <label for="desc">Description</label>
                        ...
                        <div class="card-body">
                            <form action="{{ route('user.page_title_desc') }}" method="post">
                                ...
                                <div class="form-group">
                                    <label for="bg_title">Big Title</label>
                                    <input type="text" class="form-control" name="bg_title" id="bg_title"
                                        value="{{ userSetting('project_title_desc') !== null ? userSetting('project_title_desc')->bg_title : '' }}">
                                </div>
                                <div class="form-group">
                                    <label for="title">Title</label>
                                    <input type="text" class="form-control" name="title" id="title"
                                        value="{{ userSetting('project_title_desc') !== null ? userSetting('project_title_desc')->title : '' }}">
                                </div>
                                <div class="form-group">
                                    <label for="desc">Description</label>
                        ...
                        <div class="card-body">
                            <form action="{{ route('user.page_title_desc') }}" method="post">
                                ...
                                <div class="form-group">
                                    <label for="bg_title">Big Title</label>
                                    <input type="text" class="form-control" name="bg_title" id="bg_title"
                                        value="{{ userSetting('contact_title_desc') !== null ? userSetting('contact_title_desc')->bg_title : '' }}">
                                </div>
                                <div class="form-group">
                                    <label for="title">Title</label>
                                    <input type="text" class="form-control" name="title" id="title"
                                        value="{{ userSetting('contact_title_desc') !== null ? userSetting('contact_title_desc')->title : '' }}">
                                </div>
                                <div class="form-group">
                                    <label for="desc">Description</label>
                        ...
                        <div class="card-body">
                            <form action="{{ route('user.page_title_desc') }}" method="post">
                                ...
                                <div class="form-group">
                                    <label for="bg_title">Big Title</label>
                                    <input type="text" class="form-control" name="bg_title" id="bg_title"
                                        value="{{ userSetting('hireme_title_desc') !== null ? userSetting('hireme_title_desc')->bg_title : '' }}">
                                </div>
                                <div class="form-group">
                                    <label for="title">Title</label>
                                    <input type="text" class="form-control" name="title" id="title"
                                        value="{{ userSetting('hireme_title_desc') !== null ? userSetting('hireme_title_desc')->title : '' }}">
                                </div>
                                <div class="form-group">
                                    <label for="desc">Description</label>
