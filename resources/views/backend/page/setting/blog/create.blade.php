                ...
                <div class="row">
                                ...
                                <div class="form-body">
                                    <div class="mb-3 position-relative">
                                        ...
                                        <input class="form-control" placeholder="Post title" required="required"
                                            name="title" type="text" id="title" aria-required="true">
                                    ...
                                    <div class="mb-3 position-relative">
                                        ...
                                        <textarea class="form-control" cols="10" rows="8" placeholder="Write your description" required="required"
                                            id="" name="desc" cols="50" aria-required="true" style=""></textarea>
                    ...
                    <div class="col-md-3 gap-3 d-flex flex-column-reverse flex-md-column mb-md-0 mb-5">
                        ...
                        <div class="card mb-2">
                            ...
                            <div class="card-body">
                                <select class="form-control form-select" required="required" id="category"
                                    name="category_id" aria-required="true">
                                    ...
                                    <div style="width: 8rem" class=" mb-1">
                                        <div id="" style="">
                                            <img style="width: 100%;" id="image_preview"
                                                src="{{ asset('assets/img/placeholder.png') }}" alt="Preview image">
                                        </div>
                                    </div>
                                </div>
                            </div>
