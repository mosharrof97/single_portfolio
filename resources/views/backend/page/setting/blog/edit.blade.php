                                ...
                                <div class="form-body">
                                    <div class="mb-3 position-relative">
                                        ...
                                        <input class="form-control" placeholder="Post title" required="required"
                                            name="title" value="{{ $blog->title }}" type="text" id="title"
                                            aria-required="true">
                                    ...
                                    <div class="mb-3 position-relative">
                                        ...
                                        <textarea class="form-control" cols="10" rows="8" placeholder="Write your description" required="required"
                                            id="desc" name="desc" cols="50" aria-required="true" style="">{{ $blog->desc }}</textarea>
                                ...
                                <select class="form-control form-select" required="required" id="category"
                                    ...
                                    @foreach ($categorys as $data)
                                        <option value="{{ $data->id }}"
                                            {{ $data->id == $blog->category_id ? 'selected' : '' }}>{{ $data->category }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="card mb-2">
                            ...
                            <div class=" card-body">
                                <select class="form-control form-select" required="required" id="status" name="status"
                                    ...
                                    <option value="1" {{ $blog->status == '1' ? 'selected' : '' }}>Unpublished
                                    </option>
                            ...
                            <div class=" card-body">
                                <div class="">
                                    ...
                                    <div style="width: 8rem" class=" mb-1">
                                        <div id="" style="">
                                            <img style="width: 100%;" id="image_preview" src="{{ asset($blog->image) }}"
                                                alt="Preview image">
                                        </div>
                                    </div>
                                </div>
