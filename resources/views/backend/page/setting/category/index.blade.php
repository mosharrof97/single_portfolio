            ...
            <div id="commonForm_aca">
                ...
                @foreach ($categorys as $key => $data)
                    <div class="d-flex justify-content-between mt-3 mb-2">
                        ...
                        <div class="edit-tools" id="edit-tools_{{ $data->id }}" style="">
                            <button class="btn btn-primary edit_btn" id="upd_edit_btn_{{ $data->id }}"
                                data-id="{{ $data->id }}" aria-label="Edit category"><i
                                    class="icon-pencil-o"></i>Edit</button>
                            <button class="btn btn-danger" aria-label="Delete category" data-bs-toggle="modal"
                                data-bs-target="#deletecategory_{{ $data->id }}">Delete</button>
                        </div>
                    </div>

                    <div class="modal fade" id="deletecategory_{{ $data->id }}" data-bs-backdrop="static"
                        data-bs-keyboard="false" tabindex="-1" aria-labelledby="deletecategoryLabel_{{ $data->id }}"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body p-5">
                                    <h1 class="modal-title fs-4" id="deletecategoryLabel_{{ $data->id }}"> <i
                                    ...
                                    <div class="text-end">
                                        ...
                                        <a href="{{ route('category.delete', $data->slug) }}"
                    ...
                    <div class="category_edit" id="category_edit_{{ $data->id }}" style="display: none">
                        <form action="{{ route('category.update', $data->slug) }}" class="" id=""
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" required="required" class="form-control" name="category"
                                        id="category" value="{{ $data->category }}">
                                </div>

                                <div class="col-md-12">
                                    <div class="text-end">
                                        <input type="submit" class="btn btn-primary" title="Save new category information"
                                            value="Save">
                ...
                <div class="">
                    <div class="sub-header">
                        ...
                        <div class="edit-tools" style="display: none;">
                            <button class="btn edit-btn" aria-label="Edit category"><i
                                    class="icon-pencil-o"></i>&nbsp;Edit</button>
                            <button class="btn delete-btn" aria-label="Delete category">&nbsp;Delete</button>
                        </div>
                    </div>
                    <form action="{{ route('category') }}" class="" id="" method="POST"
