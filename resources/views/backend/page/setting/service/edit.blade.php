...
@section('content')
    ...
    <div class="page-body page-content">
        <div class="container-xl">
            <form action="{{ route('service.edit', $service->slug) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
                        ...
                        <div class="card mb-2">
                            ...
                            <div class=" card-body">
                                <select class="form-control form-select" required="required" id="status" name="status"
                                    aria-required="true">
                                    <option value="2" {{ $service->status == '2' ? 'selected' : '' }}>Published
                                    </option>
                                    <option value="0" {{ $service->status == '0' ? 'selected' : '' }}>Draft</option>
                                    <option value="1" {{ $service->status == '1' ? 'selected' : '' }}>Unpublished
                                    </option>
                                </select>
