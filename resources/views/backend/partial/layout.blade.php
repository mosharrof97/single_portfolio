...
<head>
    ...
    <title>{{ auth()->guard('web')->user()->name }}</title>
            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    <ul class="nav nav-secondary">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('personal.details') }}" class="">
                                <i class="fas fa-home"></i>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('address.details') }}" class="">
                                <i class="fas fa-home"></i>
                                <p>Address details</p>
                                <span class="caret"></span>
                            </a>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('career.application') }}" class="">
                                <i class="fas fa-home"></i>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('certification') }}" class="">
                                <i class="fas fa-home"></i>
