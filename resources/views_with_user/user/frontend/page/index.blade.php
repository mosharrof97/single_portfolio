@extends('user.frontend.partial.layout')
@section('content')
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4 d-flex">
                <div class="img-about img d-flex align-items-stretch">
                    <div class="overlay"></div>
                    <div class="img d-flex align-self-stretch align-items-center" style="background-image:url('{{ asset('assets/img/personal/'.$user->personal->image)}}');">
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 col-lg-8 pl-lg-5 pb-md-5">
                    <div class="row justify-content-start pb-3">
                        <div class="col-md-12 heading-section ftco-animate">
                            ...
                            <li><span>Birthday</span> : <span>{{ $user->personal ? $user->personal->date_of_birth->format('d-M-Y') : '10-jan-2000' }}</span></li>
                            <li><span>Phone</span> : <span>{{ $user->personal ? $user->personal->mobile : '+8801700-000000'}}</span></li>
                            <li><span>Email</span> : <span>{{ $user->personal ? $user->personal->email : 'test@exmple.com'}}</span></li>
                            <li><span>From</span> : <span>{{ $user->address ? $user->address->present_village.', '.$user->address->present_office.', '.$user->address->present_thana.', '.$user->address->present_district.', '.$user->address->present_country : 'Dhaka, Bangladesh'}}</span></li>
                            <li><span>Language</span> : <span>{{ $user->address ? $user->language->language :'Bangla, English' }}</span></li>
    ...
    <div class="container">
        <div class="row justify-content-center py-5 mt-5">
            <div class="col-md-12 heading-section text-center ftco-animate">
                <h1 class="big big-2">{{ userFrontendSetting('service_title_desc', $user->username) !== null ? userFrontendSetting('service_title_desc', $user->username)->bg_title : 'Services'}}</h1>
                <h2 class="mb-4">{{ userFrontendSetting('service_title_desc', $user->username) !== null ? userFrontendSetting('service_title_desc', $user->username)->title : 'Services'}}</h2>
                <p>{{ userFrontendSetting('service_title_desc', $user->username) !== null ? userFrontendSetting('service_title_desc', $user->username)->desc : 'Far far away, behind the word mountains, far from the countries Vokalia and Consonantia'}}</p>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-4 text-center d-flex ftco-animate">
                <div class="services-1">
                    ...
                    <div class="desc mb-3">
                        <h5 class="">{{ userFrontendService('service_2', $user->username)->name ?? 'Phtography'}}</h5>
                        <p>{{ userFrontendService('service_2', $user->username)->desc ?? 'I have knowledge in designing Entity-Relationship (ER) diagrams for databases.'}}</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 text-center d-flex ftco-animate">
                <div class="services-1">
                    ...
                    <div class="desc mb-3">
                        <h5 class="">{{ userFrontendService('service_3', $user->username)->name ?? 'Web Developer'}}</h5>
                        <p>{{ userFrontendService('service_3', $user->username)->desc ?? 'I have knowledge in designing Entity-Relationship (ER) diagrams for databases.'}}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 text-center d-flex ftco-animate">
                <div class="services-1">
                    ...
                    <div class="desc mb-3">
                        <h5 class="">{{ userFrontendService('service_4', $user->username)->name ?? 'App Developing'}}</h5>
                        <p>{{ userFrontendService('service_4', $user->username)->desc ?? 'I have knowledge in designing Entity-Relationship (ER) diagrams for databases.'}}</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 text-center d-flex ftco-animate">
                <div class="services-1">
                    ...
                    <div class="desc mb-3">
                        <h5 class="">{{ userFrontendService('service_5', $user->username)->name ?? 'Branding'}}</h5>
                        <p>{{ userFrontendService('service_5', $user->username)->desc ?? 'I have knowledge in designing Entity-Relationship (ER) diagrams for databases.'}}</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 text-center d-flex ftco-animate">
                <div class="services-1">
                    ...
                    <div class="desc mb-3">
                        <h5 class="">{{ userFrontendService('service_6', $user->username)->name ?? 'Product Strategy'}}</h5>
                        <p>{{ userFrontendService('service_6', $user->username)->desc ?? 'I have knowledge in designing Entity-Relationship (ER) diagrams for databases.'}}</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="ftco-section" id="skills-section">
    <div class="container">
        <div class="row justify-content-center pb-5">
            <div class="col-md-12 heading-section text-center ftco-animate">
                <h1 class="big big-2">{{ userFrontendSetting('skill_title_desc', $user->username) !== null ? userFrontendSetting('skill_title_desc', $user->username)->bg_title : 'Skills'}}</h1>
                <h2 class="mb-4">{{ userFrontendSetting('skill_title_desc', $user->username) !== null ? userFrontendSetting('skill_title_desc', $user->username)->title : 'My Skills'}}</h2>
                <p>{{ userFrontendSetting('skill_title_desc', $user->username) !== null ? userFrontendSetting('skill_title_desc', $user->username)->desc : 'Far far away, behind the word mountains, far from the countries Vokalia and Consonantia'}}</p>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-6 animate-box">
                <div class="progress-wrap ftco-animate">
                    <h3>{{ $data->skill }}</h3>
                    <div class="progress">
                        <div class="progress-bar color-1" role="progressbar" aria-valuenow="{{ $data->progress }}" aria-valuemin="0" aria-valuemax="100" style="width:90%">
...
<section class="ftco-section ftco-project" id="projects-section">
    <div class="container">
        <div class="row justify-content-center pb-5">
            <div class="col-md-12 heading-section text-center ftco-animate">
                <h1 class="big big-2">{{ userFrontendSetting('project_title_desc', $user->username) !== null ? userFrontendSetting('project_title_desc', $user->username)->bg_title : 'Projects'}}</h1>
                <h2 class="mb-4">{{ userFrontendSetting('project_title_desc', $user->username) !== null ? userFrontendSetting('project_title_desc', $user->username)->title : 'Our Projects'}}</h2>
                <p>{{ userFrontendSetting('project_title_desc', $user->username) !== null ? userFrontendSetting('project_title_desc', $user->username)->desc : 'Far far away, behind the word mountains, far from the countries Vokalia and Consonantia'}}</p>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-6 my-1">
                <div class="card" style="border: none; border-radius: 2%; overflow: hidden;">
                    <div class="project img ftco-animate d-flex justify-content-end align-items-end" style="background-image: url('{{ asset($data->image ? 'assets/img/user/project/'.$data->image:'assets/img/project-4.jpg')}}');">
                        <div class="overlay"></div>
                        ...
                        {{-- </div> --}}
                        <a href="{{ $data->url }}" target="_blank" class="btn btn-primary text m-3">Live Preview</a>
                    </div>
                    <div class="text text-center p-0 pb-4">
                        <span><a href="{{ $data->url }}" style="color: black;" target="_blank">{{ $data->title }}</a></span>
                    </div>
                </div>
            </div>
            @endforeach
            ...
            @else
            <div class="col-md-4">
                <div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url('{{ asset('assets/img/project-4.jpg')}}');">
                    <div class="overlay"></div>
            ...
            <div class="col-md-8">
                <div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url('{{ asset('assets/img/project-5.jpg')}}');">
                    <div class="overlay"></div>
                    <div class="text text-center p-4">
                        <h3><a href="#">Branding &amp; Illustration Design</a></h3>
                        <span>Web Design</span>
