        ...
        <div class="card-body">
            <div id="commonForm_aca">
                ...
                @foreach ($experience as $key => $data)
                            ...
                            <div class="modal-content">
                                <div class="modal-body p-5">
                                    ...
                                    <div class="text-end">
                                        ...
                                        <a href="{{ route('user.employment.delete', $data->slug) }}"
                    ...
                    <div class="experience_edit" id="experience_edit_{{ $data->id }}" style="display: none">
                        <form action="{{ route('user.employment.update', $data->slug) }}" class="" id=""
            ...
            <div class="mt-5" id="div_aca" style="display: none">
                <div class="">
                    ...
                    <form action="{{ route('user.employment') }}" class="" id="" method="POST"
