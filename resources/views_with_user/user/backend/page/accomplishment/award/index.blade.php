            ...
            <div id="commonForm_aca">
                ...
                @foreach ($awards as $key => $data)
                            ...
                            <div class="modal-content">
                                <div class="modal-body p-5">
                                    ...
                                    <div class="text-end">
                                        ...
                                        <a href="{{ route('user.award.delete', $data->slug) }}"
                                ...
                                <div class="col-12">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="edit-tools" id="edit-tools_{{ $data->id }}" style="">
                                            ...
                                            <button class="btn btn-danger" aria-label="Delete award"
                    ...
                    <div class="award_edit" id="award_edit_{{ $data->id }}" style="display: none">
                        <form action="{{ route('user.award.update', $data->slug) }}" class="" id=""
                                ...
                                <div class="col-md-12">
                                    <div class="text-end">
                                        <input type="submit" class="btn btn-primary"
                                            title="Save new award information" value="Save">
            ...
            @if (count($awards) < 5)
                <div class="mt-5" id="div_aca" style="display: none">
                    <div class="">
                        ...
                        <form action="{{ route('user.award') }}" class="" id="" method="POST"
