        ...
        <div id="commonForm_aca">
            ...
            <div class="d-flex justify-content-between mt-3 mb-2">
                ...
                <div class="edit-tools" id="edit-tools_{{ $data->id }}" style="">
                    <button class="btn btn-primary edit_btn" id="upd_edit_btn_{{ $data->id }}" data-id="{{ $data->id }}" aria-label="Edit Training"><i class="icon-pencil-o"></i>Edit</button>
                    <button class="btn btn-danger" aria-label="Delete Training" data-bs-toggle="modal" data-bs-target="#deleteTraining_{{ $data->id }}">Delete</button>
                </div>
            </div>

            <div class="modal fade" id="deleteTraining_{{ $data->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="deleteTrainingLabel_{{ $data->id }}" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body p-5">
                            <h1 class="modal-title fs-4" id="deleteTrainingLabel_{{ $data->id }}"> <i class="fas fa-trash-alt fa-lg me-1" style="color: #ff1605;"></i>DELETE</h1>

                            <p class="mt-3">Are you sure, you want to delete this record?</p>

                            <div class="text-end">
                                <button type="button" class="btn btn-info" data-bs-dismiss="modal">Close</button>
                                <a href="{{ route('user.training.delete',$data->slug) }}" class="btn btn-danger">YES, DELETE</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="Training_edit" id="Training_edit_{{ $data->id }}" style="display: none">
                <form action="{{ route('user.training.update',$data->slug) }}" class="" id="" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" required="required" class="form-control" name="title" id="title" value="{{ $data->title }}">
                        </div>
                        ...
                        <div class="form-group col-md-6" id="">
                            ...
                            <input type="text" id="topic" name="topic" class="form-control" placeholder="" value="{{ $data->topic }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" name="year" id="upd_year_{{ $data->id }}" disabled>
                        ...
                        <div class="form-group col-md-6" id="" style="">
                            ...
                            <input type="text" class="form-control" name="institute" id="institute" placeholder="" value="{{ $data->institute }}">
                        ...
                        <div class="col-md-12">
                            <div class="text-end">
                                <input type="submit" class="btn btn-primary" title="Save new Training information" value="Save">
        ...
        <div class="mt-5" id="div_aca" style="display: none">
            <div class="">
                <div class="sub-header">
                    ...
                    <div class="edit-tools" style="display: none;"><button class="btn edit-btn" aria-label="Edit Training"><i class="icon-pencil-o"></i>&nbsp;Edit</button><button class="btn delete-btn" aria-label="Delete Training">&nbsp;Delete</button></div>
                </div>
                <form action="{{ route('user.training') }}" class="" id="" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="title">Training Title <span class="text-danger">*</span>
                        ...
                        <div class="form-group col-md-6" id="">
                            ...
                            <input type="text" id="topic" name="topic" class="form-control" placeholder="" value="">
                        </div>
                        ...
                        <div class="form-group col-md-6" id="" style="">
                            ...
                            <input type="text" class="form-control" name="institute" id="institute" placeholder="" value="">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" placeholder="" value="" name="duration" id="duration">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="location">location
                                @error('location')
                            ...
                            <input type="text" class="form-control" placeholder="" value="" name="location" id="location">
                        </div>
