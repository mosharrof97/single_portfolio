...
@section('content')
    ...
    <div class="page-body page-content">
        <div class="container-xl">
            <form action="{{ route('admin.update.service', $service->slug) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
                                ...
                                <div class="form-body">
                                    <div class="mb-3 position-relative">
                                        ...
                                        <input class="form-control" placeholder="Post title" required="required"
                                            name="title" value="{{ $service->title }}" type="text" id="title"
                                            aria-required="true">
                                    ...
                                    <div style="width: 8rem" class=" mb-1">
                                        <div id="" style="">
                                            <img style="width: 100%;" id="image_preview"
                                                src="{{ asset('assets/img/admin/service/' . $service->image) }}"
                                                alt="Preview image">
                                        </div>
                                    </div>
                                </div>
