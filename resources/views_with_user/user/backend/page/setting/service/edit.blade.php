...
@section('content')
    ...
    <div class="page-body page-content">
        <div class="container-xl">
            <form action="{{ route('user.service.edit', $service->slug) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
                            ...
                            <div class="card-body">
                                <div class="form-body">
                                    <div class="mb-3 position-relative">
                                        ...
                                        <input class="form-control" placeholder="Post name" required="required"
                                            name="name" value="{{ $service->name }}" type="text" id="name"
                                            aria-required="true">
                                    ...
                                    <div class="mb-3 position-relative">
                                        ...
                                        <textarea class="form-control" cols="10" rows="8" placeholder="Write your description" required="required"
                                            id="desc" name="desc" cols="50" aria-required="true" style="">{{ $service->desc }}</textarea>
                        ...
                        <div class="card mb-2">
                            ...
                            <div class=" card-body">
                                <select class="form-control form-select" required="required" id="status" name="status"
                                    aria-required="true">
                                    <option value="2" {{ $service->status == '2' ? 'selected' : '' }}>Published </option>
                                    <option value="0" {{ $service->status == '0' ? 'selected' : '' }}>Draft</option>
                                    <option value="1" {{ $service->status == '1' ? 'selected' : '' }}>Unpublished </option>
                                </select>
                            ...
                            <div class=" card-body">
                                <div class="">
                                    ...
                                    <div style="width: 8rem" class=" mb-1">
                                        <div id="" style="">
                                            <img style="width: 100%;" id="icon_preview" src="{{ asset($service->icon) }}"
                                                alt="Preview icon">
                                        </div>
                                    </div>
                                </div>
