            ...
            <div id="commonForm_aca">
                ...
                @foreach ($socialmedias as $key => $data)
                            ...
                            <div class="modal-content">
                                <div class="modal-body p-5">
                                    ...
                                    <div class="text-end">
                                        ...
                                        <a href="{{ route('user.socialmedia.delete', $data->slug) }}"
                    ...
                    <div class="socialmedia_edit" id="socialmedia_edit_{{ $data->id }}" style="display: none">
                        <form action="{{ route('user.socialmedia.update', $data->slug) }}" class="" id=""
            ...
            @if (count($socialmedias) < 3)
                <div class="mt-5" id="div_aca" style="display: none">
                    <div class="">
                        ...
                        <form action="{{ route('user.socialmedia') }}" class="" id="" method="POST"
                            ...
                            <div class="row">
                                <div class="form-group col-md-5">
                                    ...
                                    <select class="form-control" name="name" id="name">
                                        ...
                                        <option value="GitHub" {{ old('name') == 'GitHub' ? 'selected' : '' }}>GitHub</option>
