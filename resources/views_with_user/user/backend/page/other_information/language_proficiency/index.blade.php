            ...
            <div id="commonForm_aca">
                ...
                @foreach ($languages as $key => $data)
                            ...
                            <div class="modal-content">
                                <div class="modal-body p-5">
                                    ...
                                    <div class="text-end">
                                        ...
                                        <a href="{{ route('user.language.delete', $data->slug) }}" class="btn btn-danger">YES,
                                            DELETE</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="language_edit" id="language_edit_{{ $data->id }}" style="display: none">
                        <form action="{{ route('user.language.update', $data->slug) }}" class="" id=""
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select required="required" class="form-control" name="reading"
                                        id="reading">
                                        <option value="">Select</option>
                                        <option value="High" {{ $data->reading == 'High' ? 'selected' : ''}}>High</option>
                                        <option value="Medium" {{ $data->reading == 'Medium' ? 'selected' : ''}}>Medium</option>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select required="required" class="form-control" name="writing"
                                        id="writing">
                                        <option value="">Select</option>
                                        <option value="High" {{ $data->writing == 'High' ? 'selected' : ''}}>High</option>
                                        <option value="Medium" {{ $data->writing == 'Medium' ? 'selected' : ''}}>Medium</option>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select required="required" class="form-control" name="speaking"
                                        id="speaking">
                                        <option value="">Select</option>
                                        <option value="High" {{ $data->speaking == 'High' ? 'selected' : ''}}>High</option>
                                        <option value="Medium" {{ $data->speaking == 'Medium' ? 'selected' : ''}}>Medium</option>
                                        <option value="Low" {{ $data->speaking == 'Low' ? 'selected' : ''}}>Low</option>
                                    </select>
                                </div>                                

                                <div class="col-md-12">
                                    <div class="text-end">
                                        <input type="submit" class="btn btn-primary" title="Save new language information"
                                            value="Save">
            ...
            @if (count($languages) < 3)
                <div class="mt-5" id="div_aca" style="display: none">
                    <div class="">
                        ...
                        <form action="{{ route('user.language') }}" class="" id="" method="POST"
