            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    <ul class="nav nav-secondary">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('user.personal.details') }}" class="">
                                <i class="fas fa-home"></i>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('user.address.details') }}" class="">
                                <i class="fas fa-home"></i>
                                <p>Address details</p>
                                <span class="caret"></span>
                            </a>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('user.career.application') }}" class="">
                                <i class="fas fa-home"></i>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('user.education') }}" class="">
                                <i class="fas fa-home"></i>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('user.training') }}" class="">
                                <i class="fas fa-home"></i>
                                <p>Training</p>
                                <span class="caret"></span>
                            </a>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('user.certification') }}" class="">
                                <i class="fas fa-home"></i>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('user.employment') }}" class="">
                                <i class="fas fa-home"></i>
                        ...
                        <li class="nav-item">
                            <a data-bs-toggle="collapse" href="#other_information">
                                <i class="fas fa-layer-group"></i>
                                <p> Other Information</p>
                                <span class="caret"></span>
                            </a>
                            <div class="collapse" id="other_information">
                        ...
                        <li class="nav-item">
                            <a data-bs-toggle="collapse" href="#accomplishment">
                                <i class="fas fa-layer-group"></i>
                                <p>Accomplishment</p>
                                <span class="caret"></span>
                            </a>
                            <div class="collapse" id="accomplishment">
                                <ul class="nav nav-collapse">
                                    <li>
                                    ...
                                    <li>
                                        <a href="{{ route('user.award') }}">
                                            <span class="sub-item">Award</span>
                                        </a>
                                    </li>

                                    <li>
                                        <a href="{{ route('user.project') }}">
                                            <span class="sub-item">Other</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="Company_info">
                                <ul class="nav nav-collapse">
                                    ...
                                    <li>
                                        <a href="{{ route('user.page_title_desc') }}">
                                            <span class="sub-item">Page title & desc</span>
                                        </a>
                                    </li>
                                ...
                                <ul class="dropdown-menu dropdown-user animated fadeIn">
                                    <div class="dropdown-user-scroll scrollbar-outer">
                                        ...
                                        <li>
                                            ...
                                            <div class="dropdown-divider"></div>
                                            <form method="POST" class="dropdown-item" action="{{ route('user.logout') }}">
                                                @csrf
            ...
            <footer class="footer">
                <div class="container-fluid d-flex justify-content-between">
                    ...
                    <div class="copyright">
                        ...
                        <a href="#">Md. Mosharrof Hosain</a>
                    </div>
                    <div>
                        Distributed by
                        <a target="_blank" href="#">Md. Mosharrof Hosain</a>.
                    </div>
                </div>
            </footer>
        </div>
