...
class SliderController extends Controller
{
    ...
    {
        $sliders = UserSlider::where('user_id', userAuthId())->where('is_active', true)->get();
        $banner = UserBanner::where('user_id', userAuthId())->where('is_active', true)->first();
    ...
    public function update(Request $request)
    {
        ...
        $slider = UserSlider::where('user_id', userAuthId())->where('id', $request->slider_id)->first();
        if(!$slider){
    ...
    {
        $slider = UserSlider::where('user_id', userAuthId())->where('id', $id)->first();
