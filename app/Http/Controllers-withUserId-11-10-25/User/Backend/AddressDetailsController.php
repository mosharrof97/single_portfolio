...
class AddressDetailsController extends Controller
{
    ...
    public function index()
    {
        ...
        $addressDetails = AddressDetails::where('user_id',userAuthId())->where('is_active',true)->first();
    ...
    public function update(Request $request)
    {
        ...
        $address = AddressDetails::where('user_id',userAuthId())->where('is_active',true)->first();
        $address->update($data);
