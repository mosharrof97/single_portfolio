...
class BlogController extends Controller
{
    ...
    {
        $blogs = UserBlog::where('user_id',userAuthId())->orderBy('id','asc')->get();
    ...
    {
        $categorys = UserBlogCategory::where('user_id',userAuthId())->where('is_active',true)->orderBy('id','asc')->get();
    ...
    {
        $categorys = UserBlogCategory::where('user_id',userAuthId())->where('is_active',true)->orderBy('id','asc')->get();
        $blog = UserBlog::where('user_id',userAuthId())->where('slug',$slug)->orderBy('id','asc')->first();
    ...
    public function update(Request $request, string $slug)
    {
            ...
            $blog = UserBlog::where('user_id',userAuthId())->where('slug', $slug)->first();
            if(!$blog){
