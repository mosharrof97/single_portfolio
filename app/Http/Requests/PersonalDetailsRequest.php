...
class PersonalDetailsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'national_id' => 'nullable|string|max:20|unique:personal_details,national_id',
            'passport_no' => 'nullable|string|max:20|unique:personal_details,passport_no',
            'issue_date' => 'nullable|date|before_or_equal:today',
            // 'country_code' => 'required|string|max:10',
            'mobile' => 'required|string|regex:/^\+?[0-9]{10,15}$/|unique:personal_details,mobile',
